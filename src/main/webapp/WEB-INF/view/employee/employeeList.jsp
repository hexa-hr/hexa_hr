...
<script>
	...
	/employee/register2.do?employeeId='
				+ empId + '&tab=retirement';
		...
		<div class="container">
			...
			<form action="<%=request.getContextPath()%>/employee/delete.do"
				...
				<div class="btn-wrap">
					...
					<button type="button" class="btn-blue"
						onclick="alert('一括登録機能は準備中です。');">新規社員一括登録</button>
					<button type="submit" class="btn-gray">選択削除</button>
					<button type="button" class="btn-gray"
						onclick="alert('Excelダウンロード機能は準備中です。');">Excelダウンロード</button>
				</div>
			</form>
		</div>
	</div>
