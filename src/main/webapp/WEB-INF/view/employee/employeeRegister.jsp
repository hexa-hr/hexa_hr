...
<body>
			...
			<form action="<%=request.getContextPath()%>/employee/register.do" method="post" target="hidden_iframe" onsubmit="return validateForm();">
				...
				<table>
					...
					<tr>
						...
						<th>계좌번호</th>
						<td><input type="text" name="accountNumber" placeholder="- 제외하고 입력"></td>
					</tr>
					<tr>
						<th>예금주</th>
						<td colspan="3"><input type="text" name="depositStocks" style="width: 36%;"></td>
					</tr>
				</table>
				...
				<div class="section-title" id="dependents">* 가족 사항<button type="button" onclick="addDependentRow()" style="float: right; padding: 3px 8px; font-size: 12px; background-color: #1cc88a; color: white; border: none; border-radius: 3px; cursor: pointer;">+ 가족 추가</button></div>
				...
				<div class="section-title" id="degree">학력 사항<button type="button" onclick="addDegreeRow()" style="float: right; padding: 3px 8px; font-size: 12px; background-color: #f6c23e; color: white; border: none; border-radius: 3px; cursor: pointer;">+ 학력 추가</button></div>
				...
				<div class="section-title" id="military">병역 사항<button type="button" class="add-btn" onclick="addMilitaryRow()" style="float: right; padding: 3px 8px; font-size: 12px; background-color: #36b9cc; color: white; border: none; border-radius: 3px; cursor: pointer;">+ 병역 추가</button></div>
	...
	<script>
		window.onload = function() { addDependentRow(); addDegreeRow(); addMilitaryRow(); };
		...
		function addDependentRow() {
			...
			cell6.innerHTML = '<button type="button" onclick="deleteRow(this, \'dependentTable\')" style="background-color: #e74a3b; color: white; border: none; border-radius: 3px; cursor: pointer;">X 삭제</button>';
			cell1.style.textAlign = "center"; cell2.style.textAlign = "center"; cell3.style.textAlign = "center"; cell4.style.textAlign = "center"; cell5.style.textAlign = "center"; cell6.style.textAlign = "center";
		}
		...
		function addDegreeRow() {
			...
			cell7.innerHTML = '<button type="button" onclick="deleteRow(this, \'degreeTable\')" style="background-color: #e74a3b; color: white; border: none; border-radius: 3px; cursor: pointer;">X 삭제</button>';
			cell1.style.textAlign = "center"; cell2.style.textAlign = "center"; cell3.style.textAlign = "center"; cell4.style.textAlign = "center"; cell5.style.textAlign = "center"; cell6.style.textAlign = "center"; cell7.style.textAlign = "center";
		}
		...
		function addMilitaryRow() {
			...
			var html = '<td><select name="serviceType" style="width:90%;"><option value="">선택</option><option value="필">필</option><option value="미필">미필</option><option value="면제">면제</option></select></td>'
					...
					+ '<td><button type="button" onclick="deleteRow(this, \'militaryTable\')" style="background-color: #e74a3b; color: white; border: none; border-radius: 3px; cursor: pointer;">X 삭제</button></td>';
			row.innerHTML = html;
			for(let i=0; i<row.cells.length; i++) { row.cells[i].style.textAlign = "center"; }
		}
